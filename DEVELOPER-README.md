...
- **PIM-Global-Teams-v2.ps1** - Your PowerShell script (must be in the project root)
...
├── PIM-Global-Teams-v2.ps1         # PowerShell script with Teams integration
...
1. **Extraction**: The EXE extracts `PIM-Global-Teams-v2.ps1` and MSAL DLLs to a temporary directory
...
- `PIM-Global-Teams-v2.ps1` - Main PowerShell script
...
- `PIMGlobalMSTLauncher.PIM-Global-Teams-v2.ps1`
...
- `PIM-Global-Teams-v2.ps1` in project root
...
- **[GitHub Releases](https://github.com/markorr321/PIM-Global-MST/releases)** - Download links and release notes
