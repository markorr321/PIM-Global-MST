...
function Show-PIMGlobalHeader {
    ...
    function Send-TeamsNotification {
        ...
        try {
            ...
            $response = Invoke-RestMethod -Uri $teamsWebhookUrl -Method Post -ContentType 'application/json' -Body $jsonCard -TimeoutSec 10
            return $true
        } catch {
            return $false
        }
    ...
    function Send-ApprovalRequiredNotification {
        ...
        try {
            ...
            $response = Invoke-RestMethod -Uri $approvalChannelWebhookUrl -Method Post -Body $jsonBody -ContentType "application/json" -TimeoutSec 10
